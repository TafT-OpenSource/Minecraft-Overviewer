...
* **nether** - enables nether-mode by removing the top set of contiguous in each column.
integrated nether rendering, as shown on the example map, is not currently supported (default: False)
